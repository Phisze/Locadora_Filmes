...
${OBJECTDIR}/controle/conEntradaFilme.o: controle/conEntradaFilme.c
	${MKDIR} -p ${OBJECTDIR}/controle
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/controle/conEntradaFilme.o controle/conEntradaFilme.c
...
${OBJECTDIR}/controle/conLocacaoFilme.o: controle/conLocacaoFilme.c
	${MKDIR} -p ${OBJECTDIR}/controle
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/controle/conLocacaoFilme.o controle/conLocacaoFilme.c
...
${OBJECTDIR}/controle/conPersistencia.o: controle/conPersistencia.c
	${MKDIR} -p ${OBJECTDIR}/controle
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/controle/conPersistencia.o controle/conPersistencia.c
...
${OBJECTDIR}/controle/vetorCategoria.o: controle/vetorCategoria.c
	${MKDIR} -p ${OBJECTDIR}/controle
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/controle/vetorCategoria.o controle/vetorCategoria.c

${OBJECTDIR}/controle/vetorCliente.o: controle/vetorCliente.c
	${MKDIR} -p ${OBJECTDIR}/controle
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/controle/vetorCliente.o controle/vetorCliente.c

${OBJECTDIR}/controle/vetorFilme.o: controle/vetorFilme.c
	${MKDIR} -p ${OBJECTDIR}/controle
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/controle/vetorFilme.o controle/vetorFilme.c

${OBJECTDIR}/controle/vetorFornecedor.o: controle/vetorFornecedor.c
	${MKDIR} -p ${OBJECTDIR}/controle
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/controle/vetorFornecedor.o controle/vetorFornecedor.c

${OBJECTDIR}/controle/vetorFuncionario.o: controle/vetorFuncionario.c
	${MKDIR} -p ${OBJECTDIR}/controle
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/controle/vetorFuncionario.o controle/vetorFuncionario.c

${OBJECTDIR}/controle/vetorLocadora.o: controle/vetorLocadora.c
	${MKDIR} -p ${OBJECTDIR}/controle
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/controle/vetorLocadora.o controle/vetorLocadora.c
...
${OBJECTDIR}/modelo/daos/caixaDAO.o: modelo/daos/caixaDAO.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/modelo/daos/caixaDAO.o modelo/daos/caixaDAO.c
...
${OBJECTDIR}/visao/VisaoFornecedor.o: visao/VisaoFornecedor.c
	${MKDIR} -p ${OBJECTDIR}/visao
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/visao/VisaoFornecedor.o visao/VisaoFornecedor.c
...
${OBJECTDIR}/visao/locacao_filme.o: visao/locacao_filme.c
	${MKDIR} -p ${OBJECTDIR}/visao
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/visao/locacao_filme.o visao/locacao_filme.c
